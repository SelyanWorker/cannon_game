...
public:
  ...
  {
    auto nativeWindow =
        reinterpret_cast<GLFWwindow *>(selyan::Application::get()->getWindow()->getNativeWindow());
  ...
  void onRender() override
  {
    ...
    //glfwGetFramebufferSize(selyan::Application::get()->getWindow()->, &display_w, &display_h);
